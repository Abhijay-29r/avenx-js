...
async function runChartTests() {
  ...
  const rawTicks = generateLinearTicks(0, 360, 5);
  assert(rawTicks.length >= 3, 'generateLinearTicks generates nice ticks');
  ...
  assert.strictEqual(BaseChart.prototype instanceof Object, true);
