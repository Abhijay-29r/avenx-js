...
export { AvenxGuard, GuardContext } from './runtime/AvenxGuard.js';
...
// Lets an application answer "does this still need 'unsafe-eval'?" from the
// code rather than from a claim: the report lists every source compiled with
// new Function instead of parsed, with the reason.
export { getFallbackReport, isCompilable } from './expression/compile.js';

// The primitives a compiled expression calls. Exported under the short aliases
// the generator emits, so a generated module's import list is the contract
// between `lib/compiler/codegen/expression.js` and this file and nothing has to
// translate between the two.
export {
  readMember as axRead,
  writeMember as axWrite,
  callFunction as axCall,
  construct as axNew,
  readIdentifier as axGet,
  writeIdentifier as axSet,
  typeofIdentifier as axTypeof,
  guardKey as axKey,
  hasIn as axIn,
  readAmbientIdentifier as axGetAmbient,
  writeAmbientIdentifier as axSetAmbient,
  typeofAmbientIdentifier as axTypeofAmbient,
  ambientAssignmentTarget as axAmbientTarget,
  EXPRESSION_OPS,
} from './expression/ops.js';
export { isSafeUrl, isUrlAttribute } from './security/urlPolicy.js';
