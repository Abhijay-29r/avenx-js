...
class Tracer {
  ...
  constructor() {
     ...
     * @type {import('./recorder.js').TraceRecorder|null}
     */
    this.sink = null;
   ...
   * @param {import('./recorder.js').TraceRecorder} sink - The recorder to feed.
   ...
   * @returns {import('./recorder.js').TraceRecorder|null} The detached recorder.
   */
  detach() {
   ...
   * @param {string} reason - A {@link import('./schema.js').NonDeterminismReason}.
