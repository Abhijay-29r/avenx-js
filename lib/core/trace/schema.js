...
export const TraceNodeType = {
  ...
  /** A non-deterministic value the sandbox handed to application code. */
  GLOBAL: 'global',
...
export const INPUT_TYPES = new Set([
  TraceNodeType.EVENT,
  TraceNodeType.NAVIGATION,
  TraceNodeType.RESOURCE,
  TraceNodeType.GLOBAL,
]);
...
/**
 * Human-readable explanations for each {@link NonDeterminismReason}, shown by
 * `avenx trace view` and `avenx trace list`.
