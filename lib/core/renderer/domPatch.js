...
export class DomPatcher {
  ...
  #patchAttributes(oldNode, newNode) {
    ...
    let prevDynAttrs = oldNode.__avenx_dyn_attrs || [];
    ...
    if (newDynAttrs !== null) {
      ...
      oldNode.__avenx_dyn_attrs = newDynAttrs;
    }
  ...
  #applyDirectives(el, resolveExpression, app) {
    ...
    const prevDynAttrs = el.__avenx_dyn_attrs || [];
    ...
    if (currentDynAttrs.length > 0 || prevDynAttrs.length > 0) {
      el.__avenx_dyn_attrs = currentDynAttrs;
    }
