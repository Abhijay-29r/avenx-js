 ...
 * @param {string} url - The URL string.
 * @param {string} tagName - The name of the HTML tag containing the URL.
 * @param {boolean} [allowDataUrls=true] - Whether data: URLs are allowed for img tags.
 * @returns {boolean} True if the URL is safe.
 */
...
export class Sanitizer {
   ...
   * @param {boolean} [config.stripComments=true] - Whether to strip HTML comment nodes.
   * @param {string[]|Set<string>} [config.stripContentTags] - Tags whose child content is discarded when stripped.
   * @param {boolean} [config.allowDataUrls=true] - Whether data: URLs are permitted for img tags.
