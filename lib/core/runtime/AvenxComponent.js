...
export class AvenxComponent {
   ...
   * @returns {typeof AvenxComponent} The generated component subclass.
   */
  static extend(options = {}) {
    ...
    function resolveState(stateDef, context) {
      if (typeof stateDef === 'function') {
        return stateDef.call(context);
      }
      if (stateDef && typeof stateDef === 'object') {
        try {
          if (typeof structuredClone === 'function') {
            return structuredClone(stateDef);
          }
      ...
      [componentName]: class extends SuperClass {
        constructor(...args) {
          ...
          if (args.length >= 8) {
            ...
            const parentDefState = resolveState(parentOptions.state || parentOptions.data, this);
            const childDefState = resolveState(options.state || options.data, this);
