...
export class AvenxComponent {
  ...
  get #renderer() {
    if (!this.#rendererInstance) {
      this.#rendererInstance = new (requireStringRenderer().TemplateRenderer)();
    }
  ...
  get #patcher() {
    if (!this.#patcherInstance) {
      this.#patcherInstance = new (requireStringRenderer().DomPatcher)();
    }
  ...
  get #listManager() {
    if (!this.#listManagerInstance) {
      this.#listManagerInstance = new (requireStringRenderer().ListManager)(
        this.#evaluator,
        this.#renderer,
        this.#eventBinder,
        this.constructor.name,
  ...
  get #deferManager() {
    if (!this.#deferManagerInstance) {
      this.#deferManagerInstance = new (requireStringRenderer().DeferManager)(
        this.#evaluator,
        this.#renderer,
        this.#eventBinder,
        this.constructor.name,
