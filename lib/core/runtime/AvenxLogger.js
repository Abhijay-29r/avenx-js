...
export function formatContextTag(context) {
  ...
  let compName = context.componentName || context.name;
  ...
  if (!compName && context.constructor && context.constructor.name !== 'Object' && context.constructor.name !== 'Function') {
  ...
  if (
    ...
    const isExplicitContext = Boolean(
      lastArg.componentName ||
        ...
        lastArg.__filename ||
        lastArg.component ||
        (lastArg.constructor && lastArg.constructor.name !== 'Object' && lastArg.constructor.name !== 'Function')
    );
