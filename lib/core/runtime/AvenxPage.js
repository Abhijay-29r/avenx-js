...
export class AvenxPage extends AvenxComponent {
  ...
  #mountChildComponents() {
    ...
    // instead of accidental. The bound is a safety net, not a design: each
    // iteration must mount at least one new child to continue, and a template
    // that renders itself forever is a different defect (AVX_R18).
