...
export class ContractValidator {
   ...
   * @param {import('./ComponentParser.js').HTMLNode[]} nodes - Root AST nodes of template.
  ...
  static validate(nodes, metadata = {}) {
    ...
    const name = metadata.name || 'Component';
   ...
   * @param {import('./ComponentParser.js').HTMLNode} node
